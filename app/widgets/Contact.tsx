    ...
    <section id='Contact' className=" dark:bg-gray-900">
      <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
        ...
        <p className="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">
          Got a technical issue? Want to me to help to get rid od issue.Kindly contact me by refrencing your email.
        </p>
        <form action="#" className="space-y-8">
          <div>
            ...
            <input
              ...
              placeholder="name@designhenge.com"
              required
            />
          </div>
          <div>
          ...
          <button
            type="submit"
            className="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-primary sm:w-fit hover:bg-cyan-900 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
          >
            Send message
          </button>
        </form>
...
<FontAwesomeIcon width={30} height={20} icon={faCopyright} style={{color: "#333333",}} />  <h2 className='text-lg text-gray-600 font-extrabold tracking-tight'>My Portfolio 2023</h2>
